      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 bg-zinc-950 border border-zinc-800 rounded-2xl p-8">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 bg-[#39FF14]  text-white font-semibold py-4 rounded-xl transition shadow-lg hover:shadow-orange-500/30"
            >
              Send Message
        ...
        <div className="space-y-6">
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6">
            <div className="bg-orange-500/10 p-3 w-fit rounded-lg mb-4">
              <EnvelopeIcon className="w-6 h-6 text-[#39FF14]" />
            </div>
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6">
            <div className="bg-orange-500/10 p-3 w-fit rounded-lg mb-4">
              <PhoneIcon className="w-6 h-6 text-[#39FF14]" />
            </div>
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6">
            <div className="bg-orange-500/10 p-3 w-fit rounded-lg mb-4">
              <MapPinIcon className="w-6 h-6 text-[#39FF14]" />
            </div>
          ...
          <div className="bg-gradient-to-br from-[#2a0d00] to-[#3b1400] border border-orange-900/40 rounded-2xl p-6">
            <h3 className="text-[#39FF14] font-semibold mb-4">
              Why Choose Us?
            </h3>
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={item} className="flex items-center gap-3 text-gray-300">
                  <CheckCircleIcon className="w-5 h-5 text-[#39FF14]" />
                  {item}
                </li>
              ))}
            </ul>
