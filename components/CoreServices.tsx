      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <h2 className="md:text-5xl text-3xl font-bold tracking-tight">
            Our Core{" "}
            <span className="text-[#39FF14]">Services</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="relative bg-[#0b0b0b] border border-zinc-800 rounded-2xl p-12 hover:border-orange-500/40 transition-all duration-300">
            ...
            <Code2 className="text-[#39FF14] w-10 h-10 mb-8" />
            ...
            <ul className="space-y-5 mb-10">
              {[
                ...
                <li key={index} className="flex items-center gap-4 text-zinc-300 text-lg">
                  <CheckCircle2 className="text-[#39FF14] w-5 h-5" />
                  {item}
                </li>
              ))}
            </ul>

            <button className="group inline-flex items-center gap-3 border border-[#39FF14] text-[#39FF14] px-6 py-3 rounded-lg hover:bg-orange-500 hover:text-white transition-all duration-300">
              Learn More
          ...
          <div className="relative bg-[#0b0b0b] border border-zinc-800 rounded-2xl p-12 hover:border-orange-500/40 transition-all duration-300">
            ...
            <TrendingUp className="text-[#39FF14] w-10 h-10 mb-8" />
            ...
            <button className="group inline-flex items-center gap-3 border border-[#39FF14] text-[#39FF14] px-6 py-3 rounded-lg  hover:text-white transition-all duration-300">
              Learn More
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition" />
            </button>
          </div>
