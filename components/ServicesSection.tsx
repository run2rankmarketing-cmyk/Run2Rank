      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold">
            Our <span className="text-[#39FF14]">Services</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            <h3 className="text-3xl font-bold mb-3">
              Website <span className="text-[#39FF14]">Development</span>
            </h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="group bg-zinc-900 border border-zinc-800 rounded-xl p-8 hover:border-[#39FF14] transition">
            <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-orange-500/10 text-[#39FF14] mb-6">
              <Target size={22} />
            </div>
