      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <button className="inline-flex items-center gap-3 bg-orange-500 hover:bg-orange-600 transition-all duration-300 px-8 py-4 rounded-xl text-white font-semibold shadow-lg shadow-orange-500/20">
              Learn More About Us
              <ArrowRight size={18} />
            </button>
          </div>
