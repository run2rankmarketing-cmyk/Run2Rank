      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="md:text-5xl text-3xl font-bold">
            Who <span className="text-[#39FF14]">We Are</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <button className="inline-flex items-center gap-3 bg-[#39FF14] hover:bg-[#39FF14] transition-all duration-300 px-8 py-4 rounded-xl text-white font-semibold shadow-lg shadow-orange-500/20">
              Learn More About Us
              <ArrowRight size={18} />
            </button>
          </div>
