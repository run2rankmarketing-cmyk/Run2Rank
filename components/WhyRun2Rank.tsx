...
export default function WhyRun2Rank({
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-white bg-black">
      ...
      {/* Heading */}
      <h1 className="md:text-5xl text-3xl font-bold text-center mb-16">
        {title}{" "}
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl w-full mb-20">
        {features.map((feature, index) => (
          ...
          >
            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-[#39FF14]">
              <Check className="text-[#39FF14] w-5 h-5" />
            </div>
      ...
      <div className="text-center space-y-3">
        ...
        <h3 className="text-4xl md:text-5xl font-bold text-[#39FF14]">
          {subtitleBottom}
        </h3>
      </div>
    </section>
